...
2. 생성된 원격 저장소에 대회 이름에 맞는 폴더에 CodeForces 핸들로 폴더를 만들고 그 안에 소스코드를 올립니다.
...
- **PR 규칙**
  ...
  PR 제목: 대회 날짜_div.# / CodeForces 핸들
  ex) 03.21_div.2 / cnvxlns, 03.28_div.1+div.2 / prof_zoh
...
```bash
git clone https://github.com/[본인 Github 아이디]/2026-CodeForces-Study
```
